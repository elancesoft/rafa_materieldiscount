                        ...
                        case 'color' :
                            ...
                            foreach ( $terms as $term ) {
                                if ( in_array( $term->slug, $options, true ) ) {
                                    ...
                                    //$html .= '<a href="' . esc_url( $url ) . '" data-variation-image-src="' . esc_url( $variation_image_src )  . '" class="nm-shop-loop-attribute-link">';
                                    $html .= '<a href="' . esc_url( $url ) . '" class="nm-shop-loop-attribute-link">';
                                    $html .= '<i style="background:' . esc_attr( $color ) . ';" class="nm-pa-color nm-pa-color-' . esc_attr( strtolower( $term->slug ) ) . '"></i>';                   
                                    $html .= '</a>';
                                }
                            }
