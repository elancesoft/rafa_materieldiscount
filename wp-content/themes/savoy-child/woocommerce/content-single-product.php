...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( $post_class, $product ); ?>>
    <div class="nm-single-product-bg clear">
        ...
        <div class="nm-single-product-showcase">
            <div class="nm-single-product-summary-row">
        ...
        <script type="text/javascript">
            jQuery('.product-righ-col .delivery_time').insertAfter('.price ins')
            jQuery('.product-righ-col .price del').insertAfter('.price ins')
            jQuery('.product-righ-col .woocommerce-product-details__short-description').insertAfter('.sku')
        </script>
    </div>

    <div class="right-contenedeur">
        <?php
            dynamic_sidebar( 'shop-right-zone' );
        ?> 
    </div>

    <div class="die-Beschreibung">
        <?php
        /**
