...
class WC_Gateway_BACS extends WC_Payment_Gateway {
	...
	private function bank_details( $order_id = '' ) {
		...
		if ( ! empty( $bacs_accounts ) ) {
			...
			if ( $has_details ) {
				echo '<section class="woocommerce-bacs-bank-details ñlaff"><h2 class="wc-bacs-bank-details-heading">' . esc_html__( 'Our bank details', 'woocommerce' ) . '</h2>' . wp_kses_post( PHP_EOL . $account_html ) . '</section>';
			}
		}
