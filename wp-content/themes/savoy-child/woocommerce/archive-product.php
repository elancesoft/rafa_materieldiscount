...
// Breadcrumbs
    $hide_breadcrumbs = apply_filters( 'nm_shop_breadcrumbs_hide', false );
    if ( $hide_breadcrumbs ) {
            ...
            <div class="nm-shop-products-col <?php echo esc_attr( $shop_column_size ); ?>">
                ...
                <div id="nm-shop-browse-wrap" class="nm-shop-description-<?php echo esc_attr( $nm_theme_options['shop_description_layout'] ); ?>">
                    ...
                    if ( woocommerce_product_loop() ) {
                         ...
                         */
                        do_action( 'woo_custom_catalog_ordering' );
...
<script>
    ...
    jQuery(document).ready(function($) {
        jQuery('.nm-products .product-category').wrapAll('<ul class="listcat"></ul><h2>Produits</h2>')
    });
