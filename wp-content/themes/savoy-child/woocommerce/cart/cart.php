...
<h1><?php esc_html_e( 'Panier', 'nm-framework' ); ?></h1>
	...
	<tbody>
		...
		<tr>
			<td colspan="3" class="actions">
                ...
                <button type="submit" class="button border hidden udpatecart" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
...
<div class="cart-collaterals">
    ...
    <h2><?php _e( 'Résumé d&#39achats', 'woocommerce' ); ?></h2>    
