...
<div id="nm-top-bar" class="nm-top-bar">
    <div class="nm-row">
        <div class="nm-top-bar-left col-xs-<?php echo esc_attr( $column_left_size ); ?>">
            ...
            <div class="nm-top-bar-text"><span class="site-language">Langue: française <img src="https://materiel.discount/wp-content/uploads/2021/10/france-flag-png-large.jpg" class="french-flag"></span></div>
             <ul >
                 
             </ul>
             <a href="tel:0890100364" style="float:right; color:#fff; margin-right: 7px;">Tel: 08 90 100 364 *</a>
        </div>
