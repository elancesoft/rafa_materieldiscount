...
<script> 
    ...
    jQuery(document).ready(function() {
        ...
        jQuery('<li class="control-menu-gastro"><h5>Matériels alimentaire</h5></li><li class="menu-gastro"></li>').prependTo('#nm-main-menu-ul , #nm-mobile-menu-main-ul')
        ...
        jQuery( '#nm-main-menu-ul li.menu-item-has-children , #nm-mobile-menu-main-ul .menu-item-has-children' ).each( function(){
            jQuery(this).find('.nm-menu-item-image-title').each( function(){
                ...
                if (jQuery(this).text() === 'Four à vapeur combiné') {
                    jQuery(this).addClass('four')
                    jQuery(this).parent().parent().addClass('gastrog')
                }

                if (jQuery(this).text() === 'Éclairage') {
                    jQuery(this).addClass('eclaire')
                    jQuery(this).parent().parent().addClass('moebelg')
                }

                if (jQuery(this).text() === 'Rinçage et nettoyage') {
                    jQuery(this).addClass('rincage')
                    jQuery(this).parent().parent().addClass('gastrog')
                }

                if (jQuery(this).text() === 'Étagères des magasins') {
                ...
                if (jQuery(this).text() === 'Meuble de séparation') {
                ...
                if (jQuery(this).text() === 'Panneaux de fibres minérales') {
                ...
                if (jQuery(this).text() === 'Les vêtements') {
                ...
                if (jQuery(this).text() === 'Vitrines réfrigérées') {
                ...
                if (jQuery(this).text() === 'Petits équipements') {
                    jQuery(this).addClass('cl')
                    jQuery(this).parent().parent().addClass('gastrog')
                }
                ...
                if (jQuery(this).text() === 'Café et glaces') {
                    jQuery(this).addClass('cafe')
                    jQuery(this).parent().parent().addClass('gastrog')
                }

                if (jQuery(this).text() === 'Boîtes en treillis') {
                ...
                if (jQuery(this).text() === 'Électroménagers de cuisine') {
                    jQuery(this).addClass('electro')
                    jQuery(this).parent().parent().addClass('gastrog')
                }

                if (jQuery(this).text() === 'Barrière') {
